...
from data_platform_architect.models import EvidenceInput, PlatformBriefInput, RunStatus
from data_platform_architect.persistence import InMemoryRunStateRepository
from data_platform_architect.providers.mock import MockProvider
from data_platform_architect.workflow import DEFAULT_STAGES, Workflow

NOW = datetime(2026, 1, 1, tzinfo=UTC)


def request() -> PlatformBriefInput:
    return PlatformBriefInput(
        case_id="test-001",
