...
from .models import ExecutionContext, PlatformBriefInput
from .observability import configure_logging
from .persistence import JsonRunStateRepository
from .providers.mock import MockProvider
from .workflow import Workflow

app = typer.Typer(help="Enterprise Data Platform Architect Agent")
...
def run(
    ...
    try:
        request = PlatformBriefInput.model_validate_json(input_file.read_text(encoding="utf-8"))
