# SKILL.md — Enterprise Data Platform Architect Agent
...
- Security, privacy, sovereignty, RTO/RPO and SLA requirements
- Data volume, velocity, variety and latency expectations
- Preferred/forbidden technologies

    ## 4. Required outputs

    - Recommended target architecture
- 2-4 considered alternatives with tradeoffs
- Architecture Decision Record (ADR)
- Risk register with severity/probability/mitigation
- Implementation phases and dependencies
- Mermaid architecture diagram source
- Confidence score and unresolved assumptions
...
- `adr_writer`
    ...
    - 1. `intake_and_normalize_requirements`
- 2. `identify_constraints_and_nfrs`
- 3. `generate_architecture_options`
- 4. `evaluate_security_governance_reliability_cost`
- 5. `challenge_options_with_critic`
- 6. `score_and_rank_options`
- 7. `produce_recommendation`
- 8. `generate_adr_and_implementation_roadmap`
    ...
    Maintain a provider-neutral interface in `src/data_platform_architect/providers/base.py`.
